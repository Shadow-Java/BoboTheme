...
let balloon = `
    <div class="balloon-wrap">
        <img src="/media/images/balloon.png" id="bg-balloon-small">
        <img src="/media/images/balloon.png" id="bg-balloon-large">
        <img src="/media/images/logo.png" id="bg-balloon-logo">
    </div>
